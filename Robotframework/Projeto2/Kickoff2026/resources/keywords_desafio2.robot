...
Library    XML
Resource   ../variables/variables_desafio2.robot
...
Capturo a Tela
    Capture Page Screenshot          ../../tests/Evidencias/desafio2/Tela/Tela_sucesso.png

Capturo a Tela com Error
    Capture Page Screenshot          ../../tests/Evidencias/desafio2/Tela/Tela_login_Parte01_Error.png 
    Press Keys    NONE    PAGE_DOWN
    Capture Page Screenshot          ../../tests/Evidencias/desafio2/Tela/Tela_login_Parte02_Error.png    

Capturo os Elementos
    Capture Element Screenshot         ${input_username}               ../../tests/Evidencias/desafio2/Campos/FirstName.png        
    Capture Element Screenshot         ${input_password}               ../../tests/Evidencias/desafio2/Campos/LastName.png   
    Capture Page Screenshot                                            ../../tests/Evidencias/desafio2/Tela/Tela_login.png               

Capturo os Elementos com error
    Capture Element Screenshot         ${input_username}               ../../tests/Evidencias/desafio2/Campos/FirstName_Error.png        
    Capture Element Screenshot         ${input_password}               ../../tests/Evidencias/desafio2/Campos/LastName_Error.png   
